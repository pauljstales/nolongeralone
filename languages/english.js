...
const ENGLISH = {
  ...
  MISSION_INFO:
    "MISSION INFO: <br /> The alien ships are cloaked, but, any damaged parts become visible. Ships can also move at random.", //
  ...
  COORDINATES: "R0_C3", //
  THE: ", the", //
  ALIEN_SHIP_STATUS: "alien ship seems to be", //
  DAMAGED: "damaged, but alive.", //
  DESTROYED: "destroyed!", //
  SW_SELECTED: "Special weapon selected, fire the special weapon!", //
