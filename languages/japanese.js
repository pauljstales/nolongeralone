...
const JAPANESE = {
  ...
  SEND_ME_MONEY:
    "*いいえ。それが何であれ、いいえ。送金したい場合を除きます。そうすれば、はい。コーヒーやハンバーガーも受け入れられます。",
  SHOT_STATUS: "ショットステータス",
  HIT: "ヒット",
  MISS: "お嬢",
  AT: "で",
  COORDINATES: "R0_C3",
  THE: ", the",
  ALIEN_SHIP_STATUS: "エイリアンの船はそうだ",
  DAMAGED: "破損しているが生きている",
  DESTROYED: "破壊されました！",
  SW_SELECTED: "特殊武器を選択しました、特殊武器を発射してください！",
