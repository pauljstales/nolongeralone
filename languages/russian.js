...
const RUSSIAN = {
  ...
  CLICK_SQUARE:
    "* Щелкните квадрат на сетке поля битвы, чтобы выстрелить из энергетического оружия.",
  LIMITED_ENERGY:
    "* У вас ограниченная энергия, и каждый выстрел требует 1 энергии!",
  CLICK_WEAPONS: "* Щелкните 'оружие ', чтобы узнать о специальном оружии.",
  GRID_APPEARS:
  ...
  RADAR_USES:
    "* РАДАР: расходует 0 энергии и на короткое время снимает маскировку корабля пришельцев.",
  EMP_USES:
    "* ЭМИ-бомба: использует 1 энергию и на короткое время останавливает движение пришельцев.",
  PAUL_USES:
    "* PAUL: Использует 2 энергии и уничтожит любой корабль, в который попадет.",
  CAN_PAUSE:
  ...
  SEND_ME_MONEY:
    "* НЕТ. Как бы то ни было, нет. Если только ты не хочешь прислать мне деньги. Тогда да. Кофе и гамбургеры тоже принимаются.",
  SHOT_STATUS: "СТАТУС КАДРА",
  HIT: "Ударить",
  MISS: "Скучать",
  AT: "в",
  COORDINATES: "R0_C3",
  THE: ",",
  ALIEN_SHIP_STATUS: "корабль пришельцев кажется",
  DAMAGED: "поврежден, но жив.",
  DESTROYED: "уничтожен!",
  SW_SELECTED: "Специальное оружие выбрано, стреляй из специального оружия!",
  SW_FIRED:
    "Произведен выстрел из специального оружия, из него нельзя стрелять снова",
  TIMER: "ТАЙМЕР",
  ENERGY: "ЭНЕРГИЯ",
  FIRE_SW: "ПОЖАРНОЕ СПЕЦИАЛЬНОЕ ОРУЖИЕ",
