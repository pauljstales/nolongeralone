 ...
 * Translated by Google Translate, verified by Aleksey Gorshenin
 * Copyright (c) 2021
 */
...
const RUSSIAN = {
  ...
  SHORTLY_AFTER: "Космический корабль ООН был уничтожен вскоре после запуска",
  WE_ARE: "Мы",
  SKIP_INTRO: "ПРОПУСТИТЬ ВСТУПЛЕНИЕ",
  NO_LONGER_ALONE: "уже не один",
  PREPARE_FOR_BATTLE: "ПРИГОТОВЬТЕСЬ К БИТВЕ",
  LIMITED_TIME_ENERGY:
    "Наши время и энергия ограничены. Защита Земли зависит от вашей способности быстро и точно нажимать на сетку поля. Удачи.",
  MISSION_INFO:
  ...
  HOW_TO_LOSE: "УСЛОВИЯ ПРОИГРЫША",
  WEAPONS: "ОРУЖИЕ",
  OTHER: "ДРУГИЕ",
  MENU: "МЕНЮ",
  CLICK_BUTTON: "* Нажмите кнопку выше, чтобы узнать больше.",
  CLICK_SQUARE:
    "* Щелкните квадрат на сетке поля битвы, чтобы выстрелить из лазерного оружия. У него есть время восстановления, поэтому не нажимайте слишком быстро!",
  LIMITED_ENERGY:
  ...
  ALIENS_CHARGING:
    "* Корабли пришельцев заряжают одну из энергетических бомб и вскоре её запустят.",
  RUN_OUT_OF:
  ...
  CAN_PAUSE:
    "* Могу я сделать паузу? НЕТ. Пришельцы нападают чтобы убить нас всех. Вы понимаете серьезность ситуации?",
  ADJUSTABLE_DIFF:
    "* Можно-ли регулировать уровень сложности? НЕТ. Пришельцы прибывают чтобы уничтожить нас, и не будут церемониться.",
  HIGH_SCORE: "* Будут ли таблица рекордов? Пока таких планов нет.",
  SEND_ME_MONEY:
  ...
  VICTORY_TEXT:
    "Молодец, командир. С инопланетянами покончено, и мы снова единственные хозяева этой галактики.",
