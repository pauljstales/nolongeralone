...
export const TRANSLATE_INTO_LANGUAGE = function translate(language) {
  ...
  CONSTANTS.HTML.TUTORIAL.TUT_TEXT_HTP3.innerText =
    CHOSEN_LANGUAGE_MODULE.USING_SPECIAL_WEAPON;
  ...
  CONSTANTS.HTML.BATTLE.BATTLE_TEXT_IS_WEAPON_READY.innerText =
    CHOSEN_LANGUAGE_MODULE.WEAPON_READY;
  CONSTANTS.HTML.BATTLE.BUTTON_ARM_SPECIAL_WEAPON.innerText =
    CHOSEN_LANGUAGE_MODULE.USE_SPECIAL_WEAPON;
  CONSTANTS.HTML.BATTLE.SCREEN_BATTLE_VICTORY_TEXT.innerText =
    CHOSEN_LANGUAGE_MODULE.VICTORY_TEXT;
